...
drug_od_counts <- read_csv("./VSRR_Provisional_Drug_Overdose_Death_Counts.csv") |>
  filter(Year == "2022",
...
plot_usmap(data = drugs_and_aliens,
   ...
   scale_fill_gradientn(colors = c("#9fee98", 
                                    ...
                                    "#557076",
                                    "#4c4c67")) +
  geom_point(data = abnormal_cities, aes(x = x, y = y, size = sightings), color = "white") +
  labs(title = "UFO Sightings Correspond to Drug Abuse, \nUS, 2022",
       subtitle = "Dots display cities with UFO sightings (bigger dots for more sightings). \nColors show number of drug overdoses",
